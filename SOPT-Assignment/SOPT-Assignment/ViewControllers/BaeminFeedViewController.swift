...
extension BaeminFeedViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .banner:
            ...
            cell.configure(BannerData.data[indexPath.row].color)
            return cell
        case .market:
...
struct CategoryData {
    ...
    static let data = [
        CategoryData(name: "음식배달", cells: [
            CategoryCellData(name: "한그릇"), CategoryCellData(name: "치킨"), CategoryCellData(name: "카페·디저트"),
            CategoryCellData(name: "피자"), CategoryCellData(name: "분식"), CategoryCellData(name: "고기"),
            CategoryCellData(name: "찜·탕"), CategoryCellData(name: "야식"), CategoryCellData(name: "패스트푸드"),
            CategoryCellData(name: "픽업"),]),
